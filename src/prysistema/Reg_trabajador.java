...
public class Reg_trabajador extends javax.swing.JInternalFrame {
    TrabajadorDao tbj;
    ComboDao cb;
    public Reg_trabajador() {
    ...
    private void initComponents() {
        ...
        btnRegistrar.setText("REGISTRAR TRABAJADOR");
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
       ...
       Trabajador nuevo = new Trabajador(0,nombre,apellido,edad,sexo,fech_nac,est_civ,direccion,distrito,departamento,email,cargo,fech_ing,estado,contrato,area,sueldo,grado);
       boolean ver = tbj.insert(nuevo);
       if(ver){
           JOptionPane.showMessageDialog(null, "Trabajador registrado correctamente");
       }else{
           JOptionPane.showMessageDialog(null, "Hubo un error al registrar trabajador");
       }
